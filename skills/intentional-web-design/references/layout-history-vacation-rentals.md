# Vacation-rental layout history

Read this file only for vacation-rental, short-term-stay, or closely related hospitality work. Apply the selection procedure in `layout-usage-registry.md` before choosing archetypes.
